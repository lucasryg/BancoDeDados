...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=DEV801\\SQLEXPRESS; Initial Catalog=InLock_Games_Tarde; user Id=sa; pwd=sa@132;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Estudio>(entity =>
            {
                ...
                entity.HasIndex(e => e.NomeEstudio)
                    .HasName("UQ__Estudio__112A5690FEF32733")
                    .IsUnique();
            ...
            modelBuilder.Entity<Jogo>(entity =>
            {
                ...
                entity.HasIndex(e => e.NomeJogo)
                    .HasName("UQ__Jogo__89AF93E496658916")
                    .IsUnique();
                ...
                entity.HasOne(d => d.IdEstudioNavigation)
                    ...
                    .HasConstraintName("FK__Jogo__IdEstudio__5FB337D6");
            });                     
            ...
            modelBuilder.Entity<Usuarios>(entity =>
            {
                ...
                entity.HasIndex(e => e.Email)
                    .HasName("UQ__Usuarios__A9D105345F00F5C4")
                    .IsUnique();
                ...
                entity.HasOne(d => d.IdTipoUsuarioNavigation)
                    ...
                    .HasConstraintName("FK__Usuarios__IdTipo__5441852A");
            });
        }
    }
}
